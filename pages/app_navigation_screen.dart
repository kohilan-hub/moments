...
class AppNavigationScreen extends GetWidget<AppNavigationController> {
                              ...
                              child: Container(
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapUserMakeupArtistoptionselected();
                                            },
                                            child: Container(
                                                width:
                                                    getHorizontalSize(375.00),
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapVendorEditingaexistingservice();
                                            },
                                            child: Container(
                                                width:
                                                    getHorizontalSize(375.00),
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapUserVenueoptionselectedchoicetapped();
                                            },
                                            child: Container(
                                                width:
                                                    getHorizontalSize(375.00),
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapUserMakeupArtistoptionselectedchoicetapped();
                                            },
                                            child: Container(
                                                width:
                                                    getHorizontalSize(375.00),
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapVendorDeletingaexistingservice();
                                            },
                                            child: Container(
                                                width:
                                                    getHorizontalSize(375.00),
                                        ...
                                        GestureDetector(
                                            onTap: () {
                                              onTapVendorHomeScreenwithservices();
                                            },
                                            child: Container(
                                                width:
                                                    getHorizontalSize(375.00),
  ...
  onTapUserMakeupArtistoptionselected() {
    Get.toNamed(AppRoutes.userMakeupArtistOptionSelectedScreen);
  }
  ...
  onTapUserVendorAccount() {
    Get.toNamed(AppRoutes.userVendorAccountScreen);
  }

  onTapOnboardingScreen1() {
    Get.toNamed(AppRoutes.onboardingScreen1Screen);
  }
  ...
  onTapUserSearchitemnotfound() {
    Get.toNamed(AppRoutes.userSearchItemNotFoundScreen);
  }
