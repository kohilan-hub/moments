...
class VendorEditingAExistingServiceScreen extends StatefulWidget {
  final DocumentReference<Map<String, dynamic>> docEntry;
  final Service user;
  const VendorEditingAExistingServiceScreen({
    Key? key,
    required this.docEntry,
    required this.user,
  }) : super(key: key);
  @override
  State<VendorEditingAExistingServiceScreen> createState() => _VendorEditingAExistingServiceScreenState();
}
...
class _VendorEditingAExistingServiceScreenState extends State<VendorEditingAExistingServiceScreen> {
  ...
  //editing controller
  late final nameEditingController = TextEditingController(text:'${widget.user.name}');
  late final categoryEditingController = TextEditingController(text:'${widget.user.category}');
  late final addressEditingController = TextEditingController(text:'${widget.user.address}');
  late final districtEditingController = TextEditingController(text:'${widget.user.district}');
  late final phoneNumberEditingController = TextEditingController(text:'${widget.user.phoneNumber}');
  late final descriptionEditingController = TextEditingController(text:'${widget.user.description}');
  late final priceEditingController = TextEditingController(text:'${widget.user.price}');


  //category field
  late String dropdownValue=widget.user.category;
