...
import 'package:moments/widgets/vender_img_button.dart';
                                                                    ...
                                                                    children: [
                                                                      Align(
                                                                          ...
                                                                          child: Padding(
                                                                              ...
                                                                              child: Text("30000", overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtExistingService.copyWith())))
                                                                    ]))
                                                          ]))),
                                              Align(
                                                  alignment: Alignment.topLeft,
                                                                ...
                                                                child:
                                                                    Container(
                                                                        ...
                                                                        child: Row(
                                                                            ...
                                                                            children: [
                                                                              Padding(padding: getPadding(left: 21, top: 18, bottom: 14), child: Text("Makeup Artist", overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtExistingService.copyWith())),
                                                                ...
                                                                child:
                                                                    Container(
                                                                        ...
                                                                        child: Column(
                                                                            ...
                                                                            mainAxisAlignment: MainAxisAlignment.start,
                                                                            children: [
                                                                              Align(alignment: Alignment.centerLeft, child: Padding(padding: getPadding(left: 21, top: 18, right: 21, bottom: 14), child: Text("No:06, Maruthanaarmadam, Manipay, Jaffna", overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtExistingService.copyWith())))
                                                                            ]))),
                                                            Align(
                                                                alignment:
                                                                    Alignment
                                                                ...
                                                                child:
                                                                    Container(
                                                                        ...
                                                                        child: Column(
                                                                            ...
                                                                            mainAxisAlignment: MainAxisAlignment.start,
                                                                            children: [
                                                                              Align(alignment: Alignment.centerLeft, child: Padding(padding: getPadding(left: 21, top: 18, right: 21), child: Text("Jaffna", overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtExistingService.copyWith()))),
                                                                      ...
                                                                      Align(
                                                                          child: Container(
                                                                              ...
                                                                              child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.start, children: [
                                                                                Align(alignment: Alignment.centerLeft, child: Padding(padding: getPadding(left: 21, top: 18, right: 21, bottom: 18), child: Text("Best apprciated makeup artist in Jaffna. Price charging is reasonable compare to others", maxLines: 3, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtExistingService.copyWith())))
                                                                              ]))),
                                                                      Align(
                                                                          alignment: Alignment
                                                                              .topLeft,
